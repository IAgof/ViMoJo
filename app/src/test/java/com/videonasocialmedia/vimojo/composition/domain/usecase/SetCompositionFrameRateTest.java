...
public class SetCompositionFrameRateTest {

  @InjectMocks SetCompositionFrameRate injectedSetCompositionFrameRateUseCase;
  ...
  public void testSetResolutionSetProfileResolution() {
    VideoFrameRate.FrameRate frameRate = VideoFrameRate.FrameRate.FPS30;

    injectedSetCompositionFrameRateUseCase.updateFrameRate(currentProject, frameRate);

   assertThat("Frame rate is set", currentProject.getProfile().getFrameRate(),
        is(frameRate));
  }
