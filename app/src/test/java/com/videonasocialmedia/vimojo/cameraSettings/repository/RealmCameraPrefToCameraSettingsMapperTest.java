...
public class RealmCameraPrefToCameraSettingsMapperTest {
  ...
  public void testMapReturnsCameraPrefWithFieldsMapped() {
    ...
    assertThat(cameraSettings.isInterfaceProSelected(),
        is(Constants.DEFAULT_CAMERA_PREF_INTERFACE_PRO_SELECTED));
    assertThat(cameraSettings.getQuality(), is(Constants.DEFAULT_CAMERA_PREF_QUALITY));
    ...
    assertThat(cameraSettings.getResolutionSetting().getResolutionsSupportedMap()
                    .get(Constants.CAMERA_PREF_RESOLUTION_720_BACK_ID), is(true));
    assertThat(cameraSettings.getResolutionSetting().getResolutionsSupportedMap()
            .get(Constants.CAMERA_PREF_RESOLUTION_1080_BACK_ID), is(true));
    assertThat(cameraSettings.getResolutionSetting().getResolutionsSupportedMap()
            .get(Constants.CAMERA_PREF_RESOLUTION_2160_BACK_ID), is(false));
    assertThat(cameraSettings.getResolutionSetting().getResolutionsSupportedMap()
            .get(Constants.CAMERA_PREF_RESOLUTION_720_FRONT_ID), is(true));
    assertThat(cameraSettings.getResolutionSetting().getResolutionsSupportedMap()
            .get(Constants.CAMERA_PREF_RESOLUTION_1080_FRONT_ID), is(true));
    assertThat(cameraSettings.getResolutionSetting().getResolutionsSupportedMap()
            .get(Constants.CAMERA_PREF_RESOLUTION_2160_FRONT_ID), is(false));
    assertThat(cameraSettings.getFrameRateSetting().getFrameRatesSupportedMap()
            .get(CAMERA_PREF_FRAME_RATE_24_ID), is(false));
    assertThat(cameraSettings.getFrameRateSetting().getFrameRatesSupportedMap()
            .get(CAMERA_PREF_FRAME_RATE_25_ID), is(false));
    assertThat(cameraSettings.getFrameRateSetting().getFrameRatesSupportedMap()
            .get(CAMERA_PREF_FRAME_RATE_30_ID), is(true));
  }
}
