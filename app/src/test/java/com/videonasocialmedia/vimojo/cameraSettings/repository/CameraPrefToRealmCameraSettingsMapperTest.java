...
public class CameraPrefToRealmCameraSettingsMapperTest {
  ...
  public void testMapReturnsARealmCameraPrefInstance() {
    ...
    resolutionsSupportedMap.put(CAMERA_PREF_RESOLUTION_2160_BACK_ID, true);
    ...
    frameRatesSupportedMap.put(CAMERA_PREF_FRAME_RATE_24_ID, false);
    frameRatesSupportedMap.put(CAMERA_PREF_FRAME_RATE_25_ID, false);
    frameRatesSupportedMap.put(CAMERA_PREF_FRAME_RATE_30_ID, true);
  ...
  public void testMapReturnsCameraPrefObjectWithMappedFields() {
    ...
    assertThat(realmCameraSettings.resolutionBack720pSupported,
        is(resolutionsSupportedMap.get(CAMERA_PREF_RESOLUTION_720_BACK_ID)));
    assertThat(realmCameraSettings.resolutionBack1080pSupported,
        is(resolutionsSupportedMap.get(CAMERA_PREF_RESOLUTION_1080_BACK_ID)));
    assertThat(realmCameraSettings.resolutionBack2160pSupported,
        is(resolutionsSupportedMap.get(CAMERA_PREF_RESOLUTION_2160_BACK_ID)));
    assertThat(realmCameraSettings.resolutionFront720pSupported,
        is((resolutionsSupportedMap.get(CAMERA_PREF_RESOLUTION_720_FRONT_ID))));
    assertThat(realmCameraSettings.resolutionFront1080pSupported,
        is(resolutionsSupportedMap.get(CAMERA_PREF_RESOLUTION_1080_FRONT_ID)));
    assertThat(realmCameraSettings.resolutionFront2160pSupported,
        is(resolutionsSupportedMap.get(CAMERA_PREF_RESOLUTION_2160_FRONT_ID)));
    ...
    assertThat(realmCameraSettings.frameRate24FpsSupported,
        is(frameRatesSupportedMap.get(CAMERA_PREF_FRAME_RATE_24_ID)));
    assertThat(realmCameraSettings.frameRate25FpsSupported,
        is(frameRatesSupportedMap.get(CAMERA_PREF_FRAME_RATE_25_ID)));
    assertThat(realmCameraSettings.frameRate30FpsSupported,
        is(frameRatesSupportedMap.get(CAMERA_PREF_FRAME_RATE_30_ID)));
    assertThat(realmCameraSettings.quality, is(quality));
    assertThat(realmCameraSettings.interfaceProSelected, is(interfaceProSelected));
  }
}
