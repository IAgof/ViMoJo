...
import com.videonasocialmedia.vimojo.record.presentation.views.custom.picometer.androidFFT.RealDoubleFFT;
...
//        }
  ...
  public STFT(AnalyzerParameters analyzerParam) {
    init(analyzerParam.getFftLen(), analyzerParam.getHopLen(), analyzerParam.getSampleRate(),
        analyzerParam.getnFFTAverage(), analyzerParam.getWndFuncName());
    micGain = analyzerParam.getMicGainDB();
    if (micGain != null) {
