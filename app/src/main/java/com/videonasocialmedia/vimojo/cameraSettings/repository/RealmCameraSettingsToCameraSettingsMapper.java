...
public class RealmCameraSettingsToCameraSettingsMapper implements
  ...
  public CameraSettings map(RealmCameraSettings realmCameraSettings) {
    ...
    resolutionsSupportedMap.put(CAMERA_PREF_RESOLUTION_720_BACK_ID,
            realmCameraSettings.resolutionBack720pSupported);
    resolutionsSupportedMap.put(CAMERA_PREF_RESOLUTION_1080_BACK_ID,
            realmCameraSettings.resolutionBack1080pSupported);
    resolutionsSupportedMap.put(CAMERA_PREF_RESOLUTION_2160_BACK_ID,
            realmCameraSettings.resolutionBack2160pSupported);
    resolutionsSupportedMap.put(CAMERA_PREF_RESOLUTION_720_FRONT_ID,
            realmCameraSettings.resolutionFront720pSupported);
    resolutionsSupportedMap.put(CAMERA_PREF_RESOLUTION_1080_FRONT_ID,
            realmCameraSettings.resolutionFront1080pSupported);
    resolutionsSupportedMap.put(CAMERA_PREF_RESOLUTION_2160_FRONT_ID,
    ...
    frameRatesSupportedMap.put(CAMERA_PREF_FRAME_RATE_24_ID, realmCameraSettings.frameRate24FpsSupported);
    frameRatesSupportedMap.put(CAMERA_PREF_FRAME_RATE_25_ID, realmCameraSettings.frameRate25FpsSupported);
    frameRatesSupportedMap.put(CAMERA_PREF_FRAME_RATE_30_ID, realmCameraSettings.frameRate30FpsSupported);
    ...
    CameraSettings cameraSettings = new CameraSettings(resolutionSetting,
            frameRateSetting, realmCameraSettings.quality, realmCameraSettings.interfaceProSelected);
