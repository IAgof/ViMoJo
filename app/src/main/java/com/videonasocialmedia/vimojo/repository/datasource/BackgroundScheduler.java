...
public class BackgroundScheduler {
  private String LOG_TAG = BackgroundScheduler.class.getSimpleName();
  ...
  @Inject
  public BackgroundScheduler(JobManager jobManager) {
    this.listeningExecutorService = MoreExecutors.listeningDecorator(
            Executors.newFixedThreadPool(BackgroundScheduler.N_THREADS));
