...
public class ApplyAudioFadeInFadeOutToVideo implements OnExportEndedListener, OnGetAudioFadeInFadeOutFromVideoListener {
    ...
    public ApplyAudioFadeInFadeOutToVideo(Video videoToEdit, int timeFadeInMs, int timeFadeOutMs){
    ...
    public void applyAudioFadeToVideo() throws IOException {
    ...
    public void onGetAudioFadeInFadeOutFromVideoSuccess(String audioFile) {
        ...
        exportSwapAudioToVideoUseCase.export(videoToEdit.getMediaPath(),audioFile, videoToEdit.getTempPath());
    }
